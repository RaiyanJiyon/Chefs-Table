    ...
    return (
        <div className="card border border-[#e0e0e2]">
            ...
            <div className="card-body items-center w-11/12 mx-auto p-0">
                ...
                <p className='text-[#878787] text-sm font-normal'>{short_description}</p>
                <div className='divider'></div>
                <h3 className='w-full'>ingredients: {ingredients.length}</h3>
                ...
                <div className='w-full mt-5 pb-6'>
                    <button onClick={() => handleCook(recipe_name, preparing_time,calories)} className="btn bg-[#0BE58A] rounded-[50px] border-none">Want to Cock</button>
                </div>
            </div>
        </div>
    );
